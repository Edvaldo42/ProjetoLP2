...
public class US4Test {
	...
	@Test
	public void testRegistrarEmprestimo() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException {
		facade.registrarEmprestimo("Gabryelle", "99999-8888", "Joao", "98888-8888", "Beatles", "28/08/2017", 7);
	}

	@Test(expected = UsuarioInvalidoException.class)
	public void testRegistrarEmprestimoUsuarioInexistente() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException {
	...
	public void testRegistrarEmprestimoItemInvalido() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException {
		facade.registrarEmprestimo("Gabryelle", "99999-8888", "Joao", "98888-8888", "SOAD", "28/08/2017", 7);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testRegistrarEmprestimoPeriodoInvalido() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testRegistrarEmprestimoPeriodoNegativo() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException {
	...
	public void testRegistrarEmprestimoInvalido() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException {
		facade.registrarEmprestimo("Gabryelle", "99999-8888", "Joao", "98888-8888", "Beatles", "28/08/2017", 7);
		facade.registrarEmprestimo("Gabryelle", "99999-8888", "Andre", "99999-9999", "Beatles", "28/08/2017", 7);
	}

	@Test
	public void testDevolverEmprestimo() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException, EmprestimoNaoEncontradoException {
		facade.registrarEmprestimo("Gabryelle", "99999-8888", "Andre","99999-9999", "Beatles", "28/08/2017", 7);
		facade.devolverItem("Gabryelle", "99999-8888", "Andre", "99999-9999", "Beatles", "28/08/2017", "03/09/2017");
	}

	@Test(expected = UsuarioInvalidoException.class)
	public void testDevolverEmprestimoUsuarioInvalido() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException, EmprestimoNaoEncontradoException {
		facade.registrarEmprestimo("Gabryelle", "99999-8888", "Andre", "99999-9999", "Beatles", "28/08/2017", 7);
	...
	public void testDevolverEmprestimoInvalido() throws UsuarioInvalidoException, ItemNaoEncontradoException, ItemEmprestadoException, EmprestimoNaoEncontradoException {
