...
public class CrudItem {
	...
	public static Item criaBluRayFilme(String nomeItem, double preco, int duracao, String genero, String classificacao, int anoLancamento) {
		Item filme = new Filme(nomeItem, preco, duracao, genero, classificacao, anoLancamento);
		return filme;
	}
	
	public static Item criaBluRayShow(String nomeItem, double preco, int duracao, int numeroFaixas, String artista, String classificacao) {
